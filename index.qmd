...
- You will need to [fork the repository of the course](https://github.com/hpcleuven/R-best-practices).
...
<!-- You will be provided with a temporary [VSC](https://www.vscentrum.be/) account with access for one day. -->
